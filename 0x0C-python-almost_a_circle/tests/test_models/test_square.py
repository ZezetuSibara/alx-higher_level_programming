...
# test_square.py
# Zezetu Sibara
"""Unittests for models/square.py. is defined
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing initialization of x."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initialization of y."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        """Message printed to stdout is captured.

        Args:
            sq (Square): what is printed to stdout.
            method (str): The method used to print.
        Returns:
