...
# test_rectangle.py
# Zezetu Sibara
"""Unittests for models/rectangle.py. is defined
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for testing initialization for width."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for testing initialization for height."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for testing initialization for x."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for testing initialization for y."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for testing Rectangle order for initialization."""
...
class TestRectangle_area(unittest.TestCase):
    """Unittests for testing the area of the Rectangle"""
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """Message is returned and printed to stdout.

        Args:
            rect (Rectangle): Used to print to stdout.
            method (str): The method used.
        Returns:
            The message printed to stdout
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
